...
int main(){
    ...
    // Creamos un puntero
    struct Alumno *apAlumno; // Creamos una variable puntero
    apAlumno = &alumno1; // Asignamos la variable alumno1 a apAlumno

    strcpy(apAlumno->mydireccion.calle,"Tepito");
    apAlumno->mydireccion.CP = 54321;

    // Mostramos los cambios por pantalla
    printf("\n\nImprimimos nuevamente el alumno: \n");
    printf("Nombre: %s\n", alumno1.nombre);
    printf("Apellido: %s\n", alumno1.apellido);
    printf("Numero de cuenta: %d\n", alumno1.numCuenta);
    printf("El promedio de sus notas es: %.2f\n", alumno1.promedio);
